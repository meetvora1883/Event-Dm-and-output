...
const CONFIG = {
  ...
  HIGH_COMMAND_ROLE_IDS: process.env.HIGH_COMMAND_ROLE_IDS ? process.env.HIGH_COMMAND_ROLE_IDS.split(',') : ['1398888612375826520', '1398888612375826519', '1398888612375826516'], // Added 3 high command roles
